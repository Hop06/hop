...
if 'aarch64' in str(current_os):
    if not os.path.isfile('h64'):
        os.system('curl -L https://github.com/hop06/libraries/blob/main/h64?raw=true > h64')
    ...
    if not os.path.isfile('h32'):
        os.system('curl -L https://github.com/hop06/libraries/blob/main/h32?raw=true > h32')
